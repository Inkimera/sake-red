...
pub fn CreateLight(light_type: u32, position: raylib.Vector3, target: raylib.Vector3, color: raylib.Color, shader: raylib.Shader) Light {
    const light = Light{
        ...
        .castShadowLoc = raylib.GetShaderLocation(shader, raylib.TextFormat("lights[%i].cast_shadow", lightsCount)),
...
pub fn UpdateLightValues(shader: raylib.Shader, light: Light) void {
    ...
    raylib.SetShaderValue(shader, light.castShadowLoc, &light.cast_shadow, raylib.SHADER_UNIFORM_INT);
